...
class SignalGenerator_API : public scopy::ApiObject
{
	...
	Q_PROPERTY(QList<double> math_record_length READ getMathRecordLength WRITE setMathRecordLength);
	Q_PROPERTY(QList<double> math_sample_rate READ getMathSampleRate WRITE setMathSampleRate);
	...
	Q_PROPERTY(QList<int> steps_up READ getStairWaveformStepsUp WRITE setStairWaveformStepsUp);
	Q_PROPERTY(QList<int> steps_down READ getStairWaveformStepsDown WRITE setStairWaveformStepsDown);
	Q_PROPERTY(QList<int> stairphase READ getStairWaveformPhase WRITE setStairWaveformPhase);
	...
	Q_PROPERTY(QList<int> line_thickness READ getLineThickness WRITE setLineThickness)
