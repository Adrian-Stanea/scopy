	...
	: QWidget{parent}
{
	...
	QObject::connect(searchBarWidget, &scopy::regmap::gui::SearchBarWidget::requestSearch, this,
			 [=](QString searchParam) {
...
{
	if(toggle) {
		QObject::connect(settings, &scopy::regmap::gui::RegisterMapSettingsMenu::autoreadToggled,
				 tabs->value(registerName), &regmap::DeviceRegisterMap::toggleAutoread);
		QObject::connect(settings, &scopy::regmap::gui::RegisterMapSettingsMenu::requestRead,
				 tabs->value(registerName), &regmap::DeviceRegisterMap::requestRead);
		QObject::connect(settings, &scopy::regmap::gui::RegisterMapSettingsMenu::requestRegisterDump,
				 tabs->value(registerName), &regmap::DeviceRegisterMap::requestRegisterDump);
		QObject::connect(settings, &scopy::regmap::gui::RegisterMapSettingsMenu::requestWrite,
				 tabs->value(registerName), &regmap::DeviceRegisterMap::requestWrite);
	} else {
		QObject::disconnect(settings, &scopy::regmap::gui::RegisterMapSettingsMenu::autoreadToggled,
				    tabs->value(registerName), &regmap::DeviceRegisterMap::toggleAutoread);
		QObject::disconnect(settings, &scopy::regmap::gui::RegisterMapSettingsMenu::requestRead,
				    tabs->value(registerName), &regmap::DeviceRegisterMap::requestRead);
		QObject::disconnect(settings, &scopy::regmap::gui::RegisterMapSettingsMenu::requestRegisterDump,
				    tabs->value(registerName), &regmap::DeviceRegisterMap::requestRegisterDump);
		QObject::disconnect(settings, &scopy::regmap::gui::RegisterMapSettingsMenu::requestWrite,
				    tabs->value(registerName), &regmap::DeviceRegisterMap::requestWrite);
	}
}
